...
@section('content')
    ...
    <section class="content">
        <div class="callout callout-info">
            ...
            <p>{{__('This feature allows you to setup auto unfollow of non-followers on your instagram account.')}}</p>
            ...
            <p class="alert alert-warning">
                <strong>{{__('Important!')}}</strong> {{__('Only 5 profiles are Unfollowed per 5 minutes, and also only one schedule per account can be active at a time.')}}
            </p>
        </div>
    ...
    <script>
        ...
        var AutoCompleteInit = function() {
            $('.js-data-ajax').select2({
                ...
                ajax: {
                    url: '{{route('search-ig-non-followers')}}',
                    dataType: 'json',
                    type: 'POST',
                    delay: 250,
