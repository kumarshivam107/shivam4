...
<head>
    <meta charset="utf-8" />
    <title>{{__('Page Not Found')}} | {{__('SocioScheduler')}}</title>
...
<div class="container error-404">
    ...
    <p> {{__('Actually, the page you are looking for does not exist.')}} </p>
    <p>
        <a href="{{route('login')}}" class="btn btn-primary"> {{__('Start Again')}} </a>
        <br>
    </p>
</div>
<!--[if lt IE 9]>
