    ...
    <section class="content">
        <div class="callout callout-info">
            ...
            <p class="alert alert-warning">
                <strong>{{__('Important!')}}</strong> {{__('Only 25 profiles are followed per 5 minutes, and also only one schedule per account can be active at a time.')}}
            </p>
        </div>
    ...
    <script>
        ...
        var AutoCompleteInit = function() {
            $('.js-data-ajax').select2({
                ...
                ajax: {
                    url: '{{route('search-tw-non-following')}}',
                    dataType: 'json',
                    type: 'POST',
                    delay: 250,
