    ...
    <section class="content">
        <div class="callout callout-info">
            ...
            <p class="alert alert-warning">
                <strong>{{__('Important!')}}</strong> {{__('Dm are sent to only 25 profiles per 5 minutes, and a Follow Back schedule has to be set in order to function! Also, only one schedule per account can be active at a time.')}}
            </p>
        </div>
        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="single">{{__('Select a Twitter Account')}}</label>
                                            <select id="single" class="form-control select2" name="twitter_account">
                                                <option></option>
